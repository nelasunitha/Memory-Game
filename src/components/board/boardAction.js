const initialState = [
  {id: 0, contents: 'Elsa', visible: true, matched: true},
  {id: 1, contents: 'Elsa', visible: true, matched: true},
  {id: 2, contents: 'Barbie', visible: true, matched: true},
  {id: 3, contents: 'Barbie', visible: true, matched: true},
  {id: 4, contents: 'Cinderella', visible: true, matched: true},
  {id: 5, contents: 'Cinderella', visible: true, matched: true},
  {id: 6, contents: 'Snow-white', visible: true, matched: true},
  {id: 7, contents: 'Snow-white', visible: true, matched: true},
  {id: 8, contents: 'Olaf', visible: true, matched: true},
  {id: 9, contents: 'Olaf', visible: true, matched: true},
  {id: 10, contents: 'Rapunzel', visible: true, matched: true},
  {id: 11, contents: 'Rapunzel', visible: true, matched: true},
...
export const selectVisibleIds = (state) => {
  return (
    state.board.filter(card => card.visible).map(card =>
       card.id
    )
  )
}
...
export const selectMatchedIds = (state) => {
  return (
    state.board.filter(card => card.matched).map(card =>
       card.id
    )
  )
}
